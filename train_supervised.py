...
def get_args_parser(add_help=True):
    ...
    parser.add_argument("--mobius-prob", default=0.2, type=float, help="Mobius tranformation invocation probability (default 0.2)")
    
    parser.add_argument("--data-path", default="/home/prachh/datasets/imagenet_1k_2012/ILSVRC/Data/CLS-LOC/", type=str, help="dataset path")
    parser.add_argument("--model", default="resnet18", type=str, help="model name")
    parser.add_argument("--device", default="cuda", type=str, help="device (Use cuda or cpu Default: cuda)")
    parser.add_argument(
        "-b", "--batch-size", default=32, type=int, help="images per gpu, the total batch size is $NGPU x batch_size"
    )
    parser.add_argument("--epochs", default=180, type=int, metavar="N", help="number of total epochs to run (old default 90 new default 108)") #old value 90
    parser.add_argument(
